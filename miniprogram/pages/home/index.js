const { identities, stations } = require('../../utils/data')
const app = getApp()
Page({
  data: { profile: {}, identity: {}, stations, latitude: 34.7527, longitude: 113.6471, markers: [], locating: false },
  onShow() {
    ...
    this.setData({ profile: session.profile, identity: identities.find((item) => item.id === session.identityId) || identities[0], markers })
  },
